...
namespace cursor\gatekeepercursor\controllers;

use cursor\gatekeepercursor\Gatekeeper;
use cursor\gatekeepercursor\assetbundles\gatekeeper\GatekeeperAsset;
...
class GatekeeperController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->renderFrontendTemplate('craft-gatekeeper-cursor/_frontend/gatekeeper');
    }
    ...
    public function actionLogin()
    {
        ...
        return $this->renderFrontendTemplate('craft-gatekeeper-cursor/_frontend/gatekeeper', $params);
    }
